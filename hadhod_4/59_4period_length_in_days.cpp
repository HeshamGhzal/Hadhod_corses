...
int period_length_in_days(speriode periode, bool includ_end_day = 0);
...
int main()
{
	...
	periode1.periode_End.day = 22;
	periode1.periode_End.month = 2;
	...
	cout << period_length_in_days(periode1);
