...
int count_overlab_days_between_two_periods(speriode periode1, speriode periode2);
...
int main()
{
	...
	periode1.periode_Start.month = 1;
	...
	cout << count_overlab_days_between_two_periods(periode1, periode2);
...
//		return 0;
//
//	if (Is_Date1_Befor_Date2(periode2.periode_Start, periode1.periode_Start))
//		swap(periode1, periode2);
//
//	speriode periode3;
//
//	periode3.periode_Start = periode2.periode_Start;
//	periode3.periode_End = periode1.periode_End;
//
//	return(period_length_in_days(periode3, 0));
//}
...
int count_overlab_days_between_two_periods(speriode periode1, speriode periode2)
{
	...
	while (Is_Date1_Befor_Date2(periode1.periode_Start, periode1.periode_End))
	{
		if (Is_date_within_period(periode1.periode_Start, periode2))
		{
			over_lab_days++;
		}
		periode1.periode_Start = Increas_date_by_one(periode1.periode_Start);
	}
