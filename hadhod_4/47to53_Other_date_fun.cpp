...
int main()
{
	...
	short Day_name = day_Order_from_Gregorian_calender_overloded(Date1);
	string WeekDayName = Weekday_Name(Day_name);
	cout << "Date                      : " << WeekDayName << " " << Date1.day << "/" << Date1.month << "/" << Date1.year << endl;

	cout << "Is " << WeekDayName << " End of week    : ";
	cout << (Is_End_of_week(Date1) ? "Yes its end of week" : "No its not end of week") << endl;

	cout << "Is " << WeekDayName << " WeekEnd        : ";
	cout << (Is_WeekEnd(Date1) ? "Yes its WeekEnd" : "No its not WeekEnd") << endl;

	cout << "Is " << WeekDayName << " a Business_Day : ";
	cout << (Is_Business_Day(Date1) ? "Yes its a Business_Day" : "No its not aBusiness_Day") << endl;

	cout << "Days until end of week    : " << Days_until_end_of_week(Date1) << endl;
	cout << "Days until weekEnd        : " << Days_until_weekEnd(Date1) << endl;
	cout << "Days until end of Month   : " << Days_until_end_of_month(Date1) << endl;
	cout << "Days until end of year    : " << Days_until_end_of_year(Date1) << endl;
