...
int Berth_days_in_days(sDate date1, sDate date2, bool include_end_day = 0);
...
int main()
{
	...
	Date2.month = 3;
	Date2.year = 2022;
	Date2 = Get_ystem_daate();

	cout << Berth_days_in_days(Date1, Date2);


	cout << "\nSystem Date: " << Date2.day << "/" << Date2.month << "/" << Date2.year << endl;
...
int Berth_days_in_days(sDate date1, sDate date2, bool include_end_day)
{
	int deffrance = 0;
